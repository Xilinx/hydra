...
(
  ...
  wire [DATA_WIDTH-1:0] from_EB_to_M0_tdata;
  wire from_EB_to_M0_tready;
  wire from_EB_to_M0_tvalid;
  ...
  EB_from_Split_to_Merge
  (
    .M_AXIS_0_tdata(from_EB_to_M0_tdata),
    .M_AXIS_0_tready(from_EB_to_M0_tready),
    .M_AXIS_0_tvalid(from_EB_to_M0_tvalid),
    .S_AXIS_0_tdata(from_S1_to_EB_tdata),
    .S_AXIS_0_tready(from_S1_to_EB_tready),
    .S_AXIS_0_tvalid(from_S1_to_EB_tvalid),
    .aclk_0(aclk_0),
    .aresetn_0(aresetn_0)
  );
  ...
  (
    ...
    .M_AXIS_1_tdata(from_S1_to_EB_tdata),
    .M_AXIS_1_tready(from_S1_to_EB_tready),
    .M_AXIS_1_tvalid(from_S1_to_EB_tvalid),
  ...
  (
    ...
    .S_AXIS_0_tdata(from_EB_to_M0_tdata),
    .S_AXIS_0_tready(from_EB_to_M0_tready),
    .S_AXIS_0_tvalid(from_EB_to_M0_tvalid),
